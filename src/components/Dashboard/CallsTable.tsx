...
export function CallsTable({ calls, showSDRColumn = false }: CallsTableProps) {
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {calls.map((call) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getScoreColor(call.efficiency_score)}`}>
